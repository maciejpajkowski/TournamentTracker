...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    public static class TextConnectorProcessor
    {
        ...
        {
            // Id, TournamentName, EntryFee, (id|id|id - EnteredTeams), (id|id|id - Prizes), (Rounds - id^id^id|id^id^id etc.)
        ...
        public static void SaveToMatchupFile(this MatchupModel matchup, string matchupFile, string matchupEntryFile)
        {
            ...
            if (matchups.Count > 0)
            {
                currentId = matchups.Max(x => x.Id) + 1;
            }
            ...
            {
                entry.SaveToMatchupEntryFile(matchupEntryFile);
            }
        ...
        public static void SaveToMatchupEntryFile(this MatchupEntryModel entry, string matchupEntryFile)
        {
            ...
            {
                currentId = matchupEntries.Max(x => x.Id) + 1;
            }
        ...
        public static void UpdateMatchupEntryFile(this MatchupEntryModel entry)
        {
            List<MatchupEntryModel> matchupEntries = GlobalConfig.MatchupEntryFile.FullFilePath().LoadFile().ConvertToMatchupEntryModels();
